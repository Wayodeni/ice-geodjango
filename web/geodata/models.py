...
class MosaicJob(models.Model):
    ...
    rgb_cog = models.FileField(upload_to="mosaics/rgb/", blank=True, null=True)
    sar_cog = models.FileField(upload_to="mosaics/sar/", blank=True, null=True)
    rgb_preview = models.FileField(upload_to="previews/rgb/", blank=True, null=True)
    sar_preview = models.FileField(upload_to="previews/sar/", blank=True, null=True)
    rgb_bounds = models.PolygonField(srid=4326, null=True, blank=True)
    sar_bounds = models.PolygonField(srid=4326, null=True, blank=True)
